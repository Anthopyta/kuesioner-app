          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form action="{{ route('register.save') }}" method="POST" class="user">
                ...
                <div class="form-group">
                  <input name="username" type="username" class="form-control form-control-user @error('username')is-invalid @enderror" id="exampleInputUsername" placeholder="Username">
                  @error('username')
                  <span class="invalid-feedback">{{ $message }}</span>
                  @enderror
                </div>
